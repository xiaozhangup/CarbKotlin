...
class Crab(anchor: Class<*>, dataFolder: () -> File, private val plugin: () -> Plugin) :
    ...
    private val placeholders by lazy { own(me.xiaozhangup.crab.compat.Placeholders(plugin())) }
    val inputs by lazy { own(me.xiaozhangup.crab.input.PlayerInputs(plugin(), this)) }
    ...
    fun registerPlaceholder(expansion: me.xiaozhangup.crab.compat.PlaceholderExpansion) {
