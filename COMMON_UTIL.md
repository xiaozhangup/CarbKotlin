...
All public general-purpose tools live under `me.xiaozhangup.carbkotlin.common`:
...
- `reflect`: annotation helpers and legacy reflection wrappers delegating to the
  ...
  `me.xiaozhangup.carbkotlin.reflect.util.ClassHelper` (Java callers use that class).

```kotlin
import me.xiaozhangup.carbkotlin.common.io.newFile
import me.xiaozhangup.carbkotlin.common.util.orNull
import me.xiaozhangup.carbkotlin.common.util.randomDouble
