 ...
 */
package me.xiaozhangup.carbkotlin.reflect.util;
...
public class ClassHelper {
    ...
    public interface ClassFinder {
        ...
        Class<?> findClass(String name, boolean initialize, ClassLoader loader) throws ClassNotFoundException;
    }

    public static ClassFinder classFinder = Class::forName;
    ...
    public static Class<?> getClass(
        ...
        try {
            ...
            if (namePrimitiveMap.containsKey(className)) {
                ...
                clazz = classFinder.findClass(toCanonicalName(className), initialize, classLoader);
            }
            return clazz;
