package me.xiaozhangup.carbkotlin.configuration.internal;
...
import me.xiaozhangup.carbkotlin.reflect.ClassMethod;
import me.xiaozhangup.carbkotlin.reflect.Reflex;
import me.xiaozhangup.carbkotlin.reflect.ReflexClass;
import me.xiaozhangup.carbkotlin.reflect.UnsafeAccess;
import me.xiaozhangup.carbkotlin.configuration.*;
            ...
            for (Field field : clazz.getDeclaredFields()) {
                ...
                if (registryConverter != null) {
                    ...
                    if (value instanceof Map) {
                        value = ConfigSection.Companion.toNightConfig(((Map<?, ?>) value), destination);
                    }
                }
