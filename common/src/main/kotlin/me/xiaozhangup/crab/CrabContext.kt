...
import me.xiaozhangup.crab.chain.*
import me.xiaozhangup.crab.command.*
import me.xiaozhangup.crab.command.component.CommandBase
import me.xiaozhangup.crab.task.Task
import me.xiaozhangup.crab.task.TaskExecutor
import java.io.File
...
open class CrabContext(
    ...
    fun debounce(delay: Long, async: Boolean = false, action: () -> Unit) =
        me.xiaozhangup.crab.task.Debounce(this, delay, async, action)
}
