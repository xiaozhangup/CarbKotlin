...
import me.xiaozhangup.carbkotlin.chain.*
...
import me.xiaozhangup.carbkotlin.task.TaskExecutor
import java.io.File
...
open class CrabContext(
    ...
    fun debounce(delay: Long, async: Boolean = false, action: () -> Unit) =
        me.xiaozhangup.carbkotlin.task.Debounce(this, delay, async, action)
}
