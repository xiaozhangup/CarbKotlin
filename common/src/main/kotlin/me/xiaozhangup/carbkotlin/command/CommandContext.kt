...
import me.xiaozhangup.carbkotlin.command.commandText
...
data class CommandContext<T>(
    ...
    fun checkPermission(permission: String): Boolean {
        return command.registry.hasPermission(sender(), permission)
    }
    ...
    fun option(vararg id: String): String? {
        ...
        return id.firstNotNullOfOrNull { lineParser.options[it] }
    }
    ...
    fun args(): Array<String> {
        ...
        if (source.isEmpty()) return emptyArray()
    ...
    fun getOrNull(id: String): String? {
        ...
        return args().getOrNull(idx)
    }

    @Deprecated("Use named command arguments instead of positional offsets", ReplaceWith("get(id)"))
