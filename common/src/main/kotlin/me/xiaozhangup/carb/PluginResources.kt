...
import me.xiaozhangup.carb.configuration.ConfigurationManager
import me.xiaozhangup.carb.configuration.ConfigurationSection
import me.xiaozhangup.carb.reflect.PluginScanner
import me.xiaozhangup.carb.redis.AlkaidRedis
import me.xiaozhangup.carb.redis.SingleRedisConnection
import me.xiaozhangup.carb.redis.fromConfig
import java.io.File
...
open class PluginResources(private val anchor: Class<*>, private val dataFolder: () -> File) : AutoCloseable {
    ...
    val lifecycle by lazy { me.xiaozhangup.carb.lifecycle.Lifecycle(scanner) }
